...
class ComputersApi(object):
    ...
    def describe_computer(self, computer_id, api_version, **kwargs):  # noqa: E501
        ...
        :param str api_version: The version of the api being called. (required)
        :param list[str] expand: Determines the computer information to include in the response. Use \"none\" to retrieve only basic computer information such as policyID and hostName. Use one or several expand options to retrieve a tailored response in addition to the basic information. Use \"all\" to retrieve all of the computer information. The default is \"all\", but we recommend using expand on all requests to improve performance.
        :param bool overrides: Show only overrides defined for the current computer.
        :return: Computer
                 If the method is called asynchronously,
                 returns the request thread.
