...
class ScanForRecommendationsTaskParameters(object):
    ...
    def __init__(self, computer_filter=None):  # noqa: E501
        """ScanForRecommendationsTaskParameters - a model defined in Swagger"""  # noqa: E501
    ...
    def computer_filter(self):
        """Gets the computer_filter of this ScanForRecommendationsTaskParameters.  # noqa: E501

        Controls which computer(s) to scan.  # noqa: E501

        :return: The computer_filter of this ScanForRecommendationsTaskParameters.  # noqa: E501
    ...
    def computer_filter(self, computer_filter):
        """Sets the computer_filter of this ScanForRecommendationsTaskParameters.

        Controls which computer(s) to scan.  # noqa: E501

        :param computer_filter: The computer_filter of this ScanForRecommendationsTaskParameters.  # noqa: E501
        :type: ComputerFilter
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ScanForRecommendationsTaskParameters, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScanForRecommendationsTaskParameters):
            return False
