...
class SynchronizeVCenterTaskParameters(object):
    ...
    def __init__(self, computer_group_id=None):  # noqa: E501
        """SynchronizeVCenterTaskParameters - a model defined in Swagger"""  # noqa: E501
    ...
    def computer_group_id(self):
        """Gets the computer_group_id of this SynchronizeVCenterTaskParameters.  # noqa: E501

        Identifies the top-level computer group for the vCenter.  # noqa: E501

        :return: The computer_group_id of this SynchronizeVCenterTaskParameters.  # noqa: E501
        :rtype: int
        """
    ...
    def computer_group_id(self, computer_group_id):
        """Sets the computer_group_id of this SynchronizeVCenterTaskParameters.

        Identifies the top-level computer group for the vCenter.  # noqa: E501

        :param computer_group_id: The computer_group_id of this SynchronizeVCenterTaskParameters.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SynchronizeVCenterTaskParameters, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SynchronizeVCenterTaskParameters):
            return False
