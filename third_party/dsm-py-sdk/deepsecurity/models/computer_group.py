...
class ComputerGroup(object):
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["ad-add-directory", "ad-folder-network", "aws-region", "aws-vpc", "aws-subnet", "aws-workspaces", "aws-directory", "azure-top", "azure-group", "cloud-provider-top", "vcloud-top", "aws-account", "vm-group", "vcloud-provider_datacenter", "vcloud-vapp", "vcenters-top", "vcenter-folder-network", "vmware-datacenter", "vcenter-cluster-group", "external-group", "folder", "root"]  # noqa: E501
