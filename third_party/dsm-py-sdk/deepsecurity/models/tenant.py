...
class Tenant(object):
    ...
    def modules_visible(self, modules_visible):
        ...
        :type: list[str]
        """
        allowed_values = ["all", "anti-malware", "web-reputation", "firewall", "intrusion-prevention", "integrity-monitoring", "log-inspection", "application-control", "SAP", "sensing-mode", "container-control"]  # noqa: E501
    ...
    def activation_codes(self):
        ...
        List of comma-delimited activation codes for the protection modules.  # noqa: E501
