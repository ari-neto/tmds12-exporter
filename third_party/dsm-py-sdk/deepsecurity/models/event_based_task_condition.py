...
class EventBasedTaskCondition(object):
    ...
    def field(self):
        ...
        The event field to match against when evaluating this condition.  # noqa: E501
    ...
    def field(self, field):
        ...
        :type: str
        """
        allowed_values = ["hostname", "vcenter", "cloudProvider", "securityGroup", "imageId", "esx", "folder", "platform", "applianceProtectionAvailable", "applianceProtectionActivated", "lastUsedIP", "tag", "nsxSecurityGroup"]  # noqa: E501
