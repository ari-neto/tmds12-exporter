...
class Ec2VirtualMachineSummary(object):
    ...
    def __init__(self, cloud_provider=None, account_id=None, operating_system=None, private_ip_address=None, public_ip_address=None, availability_zone=None, instance_id=None, security_groups=None, type=None, virtualization_type=None, state=None, metadata=None, dns_name=None, ami_id=None):  # noqa: E501
